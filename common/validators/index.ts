...
export { noteSchema, linkSchema } from './notes';
export { personalDataSchema } from './personal-data';
export { shortcutSchema } from './shortcuts';
export { flightSchema, airportSchema, airlineSchema, aircraftSchema } from './flights';
export { visitSchema } from './visits';
